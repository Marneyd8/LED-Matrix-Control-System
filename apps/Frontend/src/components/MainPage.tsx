...
const MainPage = () => {
  ...
  return (
    <div className="flex p-6">
      <div className="w-[15%] bg-gray-800 m-5">
        <Sidebar />
      </div>

      <div className="w-[85%]">
        <div className="flex justify-evenly p-6 bg-gray-800 m-5">
          <button onClick={() => handleImageClick("Drawer")} className="w-40 h-24 bg-blue-500 rounded-lg flex flex-col items-center justify-center text-white">
            <span>Drawer</span>
            <img src={pencil} alt="Drawer" className="w-40 h-14 object-cover mt-2 rounded-lg" />
          </button>
          <button onClick={() => handleImageClick("Typer")} className="w-40 h-24 bg-blue-500 rounded-lg flex flex-col items-center justify-center text-white">
            <span>Typer</span>
            <img src="path/to/image2.jpg" alt="Typer" className="w-40 h-14 object-cover mt-2 rounded-lg" />
          </button>
          <button onClick={() => handleImageClick("ImageLoader")} className="w-40 h-24 bg-blue-500 rounded-lg flex flex-col items-center justify-center text-white">
            <span>ImageLoader</span>
            <img src="path/to/image3.jpg" alt="ImageLoader" className="w-40 h-14 object-cover mt-2 rounded-lg" />
          </button>
          <button onClick={() => handleImageClick("GifLoader")} className="w-40 h-24 bg-blue-500 rounded-lg flex flex-col items-center justify-center text-white">
            <span>GifLoader</span>
