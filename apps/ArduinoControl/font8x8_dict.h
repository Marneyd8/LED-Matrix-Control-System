...
const CharBitmap font8x8[] = {
    ...
    {'s', {0x00, 0x00, 0x1E, 0x33, 0x07, 0x38, 0x1F, 0x00}},   // U+0073 (s)
    ...
    {'x', {0x00, 0x00, 0x33, 0x1E, 0x0C, 0x1E, 0x33, 0x00}},   // U+0078 (x)
    {'y', {0x00, 0x00, 0x33, 0x33, 0x33, 0x3E, 0x30, 0x1F}},   // U+0079 (y)
    {'z', {0x00, 0x00, 0x3F, 0x19, 0x0C, 0x26, 0x3F, 0x00}},   // U+007A (z)
};

const int fontSize = sizeof(font8x8) / sizeof(font8x8[0]); 
